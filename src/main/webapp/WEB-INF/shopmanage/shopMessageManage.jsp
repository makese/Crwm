...
<%--
  ...
  Date: 2017/10/15
  Time: 19:14
  To change this template use ImgFile | Settings | ImgFile Templates.
--%>
                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">公告列表</span>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $('#example').DataTable({
            lengthChange: false,
            select: true,
            ajax: "shopManage/load_shopMessage",
            columns: [
                {data: "message"},
                {data: "date"},
                {data: "admin.name"}
