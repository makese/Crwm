                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">发布用户通知</span>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#send-message").click( function () {
                ...
                if( message !== ""){
                    $.post("backManage/sendMessageToAllUser_message",{Message:message},function (data) {
