                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">发布商家通知</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <form class="mt-clipboard-container">
                                    <textarea id="mt-clipboard-paste" class="form-control" rows="3"></textarea>
                                    <a class="btn green-steel mt-clipboard"><i class="icon-note" id="send-message">发布</i></a>
                                </form>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#send-message").click( function () {
            var message = $("#mt-clipboard-paste").val();
            if( message !== ""){
                    $.post("backManage/sendMessageToAllShop_message",{Message:message},function (data) {
                       var result = data.result;
                       if(result === "success"){
                           alert("发送成功");
                           $("#mt-clipboard-paste").val("");
                       } else {
                           alert("发送失败请重试");
                       }
                    })
