                        ...
                        <div class="portlet light portlet-fit bordered">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <span class="caption-subject font-red sbold uppercase">举报列表</span>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var table = $('#example').DataTable({
            lengthChange: false,
            select: true,
            ajax: "backManage/load_report",
            columns: [
                {data: "user.userInfo.realName"},
                {data: "shop.shopInfo.shopName"},
                {data: "comment"},
                {data: null, render: function ( data, type, row ) {
                    return data.shop.reportSet.length;
                } }
            ],
        ...
        new $.fn.dataTable.Buttons(table, [
            {
                ...
                action:function (e, t, a, n) {
                    ...
                    $.post("process_report",{id:rowData.id},function (){
                        alert("处理成功");
                        t.ajax.reload();
                    });
